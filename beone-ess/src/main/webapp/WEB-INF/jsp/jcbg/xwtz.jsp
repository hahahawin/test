...
<html>
    <head>
        ...
        <script type="text/javascript" src="<%=basePath%>js/jcbg/xwtz.js"></script>
        ...
        <script>
            ...
            var ptFindCode="JCBG_TZGG_XWTZ_CX"; //分页查询code
            var insertCode="JCBG_TZGG_XWTZ_ADD"; //新增code
            var deleteCode="JCBG_TZGG_XWTZ_DEL"; //删除code
            var updateCode="JCBG_TZGG_XWTZ_EDIT"; //修改code
            var zfCode="JCBG_TZGG_XWTZ_ZF"; //作废code
        </script>
        <style>
...
<script type="text/html" id="toolHead">
    <div class="operationTableTool">
        ...
        <div class="layui-btn-container">
            ...
            {{# if(hasRight("JCBG_TZGG_XWTZ_ADD")){}}
...
<div class="operationModle" id="operationPage" style="display: none;">
    <form id="form" class="layui-form" action="" lay-filter="form">
        ...
        <div class="layui-form-item">
            <div class="layui-row">
                ...
                <%--<div class="layui-col-md4">--%>
                    ...
                    <%--<div class="layui-input-block">--%>
                        <%--<select name="GBQT" id="GBQT" title="公布群体" lay-verify="required"></select>--%>
                    <%--</div>--%>
                <%--</div>--%>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" NAME="XXLY" maxlength="50" style="width:830px;" lay-verify="special" autocomplete="off" class="layui-input" title="信息来源">
            </div>
        </div>
            ...
            <div class="layui-row">
                <div class="layui-col-md12">
                    ...
                    <div class="layui-input-block">
                        ...
                        <%--<input type="text" NAME="NR" maxlength="50" lay-verify="" autocomplete="off" class="layui-input" title="内容">--%>
                    </div>
                </div>
            </div>
        </div>
        ...
        <button style="display: none;" id="formSubmit" class="layui-btn" lay-submit lay-filter="formSubmit">存为草稿</button>
    </form>
</div>
