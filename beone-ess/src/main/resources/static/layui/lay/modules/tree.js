...
;layui.define("form", function (e) {
    ...
    g.prototype.config = {
        ...
        layui.each(l, function (a, l) {
            var o = i('<div class="layui-tree-pack" ' + (l.spread ? 'style="display: block;"' : "") + '"></div>');
            if (r.defaultStatus) {
                o = i('<div class="layui-tree-pack" style="display: block"></div>');
            }
    ...
    }, g.prototype.operate = function (e, a) {//e:对象  a:数据
        ...
        l.children(".layui-tree-btnGroup").on("click", ".layui-icon", function (l) {
            ...
            if ("add" == f) {
                addTree(JSON.stringify(a,e));
            } else if ("update" == f) {
                updateTree(JSON.stringify(a,e));
            } else if ("del" == f) {
                delTree(JSON.stringify(a,e));
            }
        })
